...
from controllers.anime_controller import get_all_anime, delete_anime, add_new_anime, update_anime, get_by_studio, get_anime_by_id
...
router.patch("/{name}", response_model=AnimeResponse)(update_anime)

router.delete("/{name}")(delete_anime)
