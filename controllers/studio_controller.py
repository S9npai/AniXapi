...
def update_studio(studio_uuid:str, studio_to_update: StudioUpdate, service: StudioService = Depends(get_studio_service)):
    return service.update_studio(studio_uuid, studio_to_update)

def delete_studio(studio_uuid:str, service:StudioService = Depends(get_studio_service)):
    return service.delete_studio(studio_uuid)
